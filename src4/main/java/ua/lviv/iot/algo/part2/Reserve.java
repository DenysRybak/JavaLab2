...
public class Reserve extends AbstractAnimalHome{
    ...
    public String getHeaders() {
        return  super.getHeaders()+ ", " + "moneyOnReserveDay, numberOfTypesOfAnimals, numberOfSection";
    }


    public String toCSV() {
        return  super.toCSV()+ ", " + moneyOnReserveDay + ", " + numberOfTypesOfAnimals + ", " + numberOfSection;
    }
